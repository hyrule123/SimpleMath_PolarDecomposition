...
namespace math
{
    ...
    struct Matrix : public XMFLOAT4X4
    {
        ...
        void DecomposePolar(Matrix& _R, Matrix& _S) const;
        Matrix Normalize(const Matrix& _m) const;
        float NormDividedBy1() const;
        Matrix Interpolate(const Matrix& _m, float _ratio);
        static Matrix Interpolate(const Matrix& _m1, const Matrix& _m2, float _ratio);
